...
from flask_uploads import SCRIPTS, EXECUTABLES, UploadSet, configure_uploads, AllExcept
...
from portfolio.bp_azurlane.routes import bp_azurlane

app.register_blueprint(bp_azurlane)
